...
protocol ManagedObjectConvertible {
    ...
    static func fetchAll(from context: NSManagedObjectContext, sortDescriptors: [NSSortDescriptor]) -> [T]
    
    static func get(object: T, with context: NSManagedObjectContext) -> Self?
